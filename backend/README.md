...
## Project Structure
    ...
    ├── testapiautostoryboa_75428  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_75428`
...
2. Clone this repo and `cd testapiautostoryboa_75428`
